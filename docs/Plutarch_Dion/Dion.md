...
??? note
    ...
    3. **τὸ παριστάμενον**: 'lo que está presente a la mente, un pensamiento'.
...
## <span class="edicion">Edición</span>
...
!!! note "Notas"
    ...
    7. [Análisis](Amnalisis/Dion_10_02.md)
    ```mermaid
    graph TB
    A("Lo animaba a ...")
