...
Α —**Πες** του **να μας πάρει** μια λάμπτα για το γραφείο, **για να δουλεύουμε** πιο άνετα.
...
|Ejemplo|Resto|Verbo| να/ας|μη(ν)|OI|OI|Verbo|Resto|
|:---------------|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---|
